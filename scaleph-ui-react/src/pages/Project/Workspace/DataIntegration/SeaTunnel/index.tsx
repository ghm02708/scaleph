...
import DataIntegrationSeaTunnelForm from './DataIntegrationSeaTunnelForm';
import {WsArtifactSeaTunnelService} from "@/services/project/WsArtifactSeaTunnelService";

const DataIntegrationSeaTunnelWeb: React.FC = () => {
  const intl = useIntl();
  ...
  const onDag = (record: WsArtifactSeaTunnel) => {
    history.push("/workspace/data-integration/seatunnel/dag", record)
  }
...
export default DataIntegrationSeaTunnelWeb;
