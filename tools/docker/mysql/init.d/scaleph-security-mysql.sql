...
INSERT INTO `sec_resource_web`(`id`, `type`, `pid`, `name`, `menu_name`, `path`, `redirect`, `layout`, `icon`, `component`, `remark`, `creator`, `editor`) VALUES (39, '1', 42, '调度', 'project.schedule', '/workspace/schedule', NULL, 1, 'ScheduleOutlined', NULL, NULL, 'sys', 'sys');
...
INSERT INTO `sec_resource_web`(`id`, `type`, `pid`, `name`, `menu_name`, `path`, `redirect`, `layout`, `icon`, `component`, `remark`, `creator`, `editor`) VALUES (83, '2', 39, '分组管理', NULL, '/workspace/schedule/group', NULL, 0, NULL, './Project/Workspace/Schedule/Group', NULL, 'sys', 'sys');
INSERT INTO `sec_resource_web`(`id`, `type`, `pid`, `name`, `menu_name`, `path`, `redirect`, `layout`, `icon`, `component`, `remark`, `creator`, `editor`) VALUES (84, '2', 39, '任务管理', NULL, '/workspace/schedule/job', NULL, 0, NULL, './Project/Workspace/Schedule/Job', NULL, 'sys', 'sys');
