...
import static cn.sliew.scaleph.plugin.seatunnel.flink.connectors.redis.sink.RedisSinkProperties.*;

@AutoService(SeaTunnelConnectorPlugin.class)
public class RedisSinkPlugin extends SeaTunnelConnectorPlugin {

    public RedisSinkPlugin() {
    ...
    protected SeaTunnelPluginMapping getPluginMapping() {
        return SeaTunnelPluginMapping.SINK_REDIS;
    }
}
